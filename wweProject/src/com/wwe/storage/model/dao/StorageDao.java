...
public class StorageDao {
	...
	public List<FileVo> selectPersonalStorageByTitle(Connection conn, String idx, String keyWord){
		List<FileVo> res = null;
		PreparedStatement pstm = null;
		ResultSet rset = null;
		...
		String sql = "select file_name,file_content,file_path,update_date,file_rename,file_idx,user_id "
					+ "from tb_private_file "
					+ "where user_id = ? and is_del = 0 and file_name like '%'||?||'%'"
					+ "order by file_idx desc";
	...
	public List<FileVo> selectShareStorageByTitle(Connection conn, String idx, String keyWord){
		List<FileVo> res = null;
		PreparedStatement pstm = null;
		ResultSet rset = null;
		...
		String teamSql = "select file_name,file_content,file_path,update_date,file_rename,file_idx,user_id "
						+ "from tb_public_file "
						+ "where project_id = ? and is_del = 0 and file_name like '%'||?||'%'"
						+ "order by file_idx desc";
